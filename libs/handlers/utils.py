...
async def _send_long_blockquote(bot_instance, chat_id: int, html_content: str):
                ...
                try:
                    await asyncio.wait_for(
                        bot_instance.send_message(
                            chat_id=chat_id, text=wrapped,
                            parse_mode="HTML" if use_blockquote != "plain" else None,
                        ),
                        timeout=timeout,
                    )
                    return True
