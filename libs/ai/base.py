...
class BaseEngine:
    ...
    def __init__(self, base_url: str = None, api_key: str = None, db_manager=None):
        ...
        self.embedder = OpenAIClient(EMBEDDING_MODEL, 0.0, 8, base_url, api_key)
        self.npc_ai = OpenAIClient(NPC_AI_MODEL, NPC_AI_TEMP, NPC_AI_MAX_TOKENS, base_url, api_key)
        self.moder_ai = OpenAIClient(MODER_AI_MODEL, MODER_AI_TEMP, MODER_AI_MAX_TOKENS, base_url, api_key)
